<template>
  <div ref="root" class="menu-root" tabindex="-1" @keydown="onKeydown" @keyup="onKeyup">
    <menu-box dense :width="menuWidth">
      ...
      <div v-else-if="hasValue" class="content">
        <div class="set-header">
          <span class="chip"><shortcut-kbd :value="value" /></span>
          <p class="desc">Toggle readability on a site.</p>
        </div>
        <div class="divider" />
...
export default Vue.extend({
  ...
  computed: {
    ...
    menuWidth(): number {
      return this.recording || this.hasValue ? 222 : 246;
    },
  },
