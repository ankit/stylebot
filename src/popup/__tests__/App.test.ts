...
describe('App.vue', () => {
  ...
  describe('restricted', () => {
    it('shows the restricted message for chrome:// pages', () => {
    ...
    it('shows the restricted message for the Chrome Web Store', () => {
    ...
    it('shows the restricted message for a PDF document', () => {
    ...
    it('does not show the restricted message for an ordinary web page', () => {
    ...
    it('skips fetching page state for restricted pages', () => {
      currentTab('chrome://extensions');
      shallowMount(App);
    ...
    it('fetches page state for ordinary pages', () => {
      currentTab('https://news.ycombinator.com');
      shallowMount(App);
  ...
  describe('showMore navigation', () => {
    ...
    it('switches to the More menu when the more button is clicked', async () => {
      currentTab('https://news.ycombinator.com');
      const wrapper = shallowMount(App);
    ...
    it('returns to the main view on "back"', async () => {
      currentTab('https://news.ycombinator.com');
      const wrapper = shallowMount(App);
    ...
    it('shows the More menu from the restricted view too', async () => {
      currentTab('chrome://extensions');
      const wrapper = shallowMount(App);
  ...
  it('fetches keyboard shortcuts on load', () => {
    currentTab('https://news.ycombinator.com');
    shallowMount(App);
