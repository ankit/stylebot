...
function handleKeyboardShortcut(e) {
  ...
  switch (e.keyCode) {
    ...
    case 72:
      if (stylebot.selectedElement) $('#stylebot-display').click();
      return false;
...
function displayShortcutHelp() {
  ...
  var sec1 =
    "<ul class='stylebot-shortcut-section'><h2>Manage Stylebot</h2> \
  ...
  var sec2 =
    "<ul class='stylebot-shortcut-section'><h2>Navigate Sections</h2> \
  ...
  var sec3 =
    "<ul class='stylebot-shortcut-section'><h2>Apply property values</h2> \
  ...
  var footer = $("<a href='#' id='stylebot-shortcuts-close'>Close</a>").click(
    closeShortcutHelp
  );
  content.append(sec1).append(sec2).append(sec3).append(footer);
