...
const IndexPage = () => (
  <Layout subtitle="Release 3.1">
    ...
    <div style={{ margin: '24px auto', textAlign: 'center' }}>
      <img src={syncGIF} height={400} />
    </div>

    <p>
      You need to enable and authorize sync via Google Drive by going to the Stylebot <strong>Options page</strong>.
      </p>
    <p>
      Once enabled, you can click on <strong>Sync Now</strong> via the icon or options page to sync your browser styles with
        styles backed up on Google Drive.
      </p>
    ...
    <div style={{ margin: '24px auto', textAlign: 'center' }}>
      <img src={resizeGIF} height={400} />
    </div>

    <p>
      You can now resize the stylebot editor. You can optionally
      enable the option to adjust the page width so that the page content does not overlap with the Stylebot editor.
      </p>
