...
(function ($) {
  var ColorPicker = (function () {
    var ids = {},
      ...
      visible,
      tpl =
        '<div class="stylebot_colorpicker"> \
      ...
      moveHue = function (ev) {
        var cal = ev.data.cal;
        var hsb_h = parseInt(
          (360 * (150 - Math.max(0, Math.min(150, ev.pageY - ev.data.y)))) /
            150,
          10
        );
      ...
      moveSelector = function (ev) {
        var cal = ev.data.cal;
        var hsb_s = parseInt(
          (100 * Math.max(0, Math.min(150, ev.pageX - ev.data.pos.left))) / 150,
          10
        );
        var hsb_b = parseInt(
          (100 *
            (150 - Math.max(0, Math.min(150, ev.pageY - ev.data.pos.top)))) /
            150,
          10
        );
      ...
      hide = function (ev) {
        if (ev.type == 'keyup' && ev.keyCode != 27) return true;
        ...
        return this.each(function () {
          if (!$(this).data('colorpickerId')) {
            ...
            options.selector = cal
              .find('div.stylebot_colorpicker_color')
