(function () {
  ...
  templates['style-modal'] = template(function (
    Handlebars,
    depth0,
    helpers,
    partials,
    ...
    function program1(depth0, data) {
      var buffer = '',
        stack1;
      buffer += '\n        ';
      stack1 = helpers['if'].call(depth0, depth0 && depth0.global, {
        hash: {},
    ...
    function program6(depth0, data) {
      var buffer = '',
        stack1;
      buffer += '\n        ';
      stack1 = helpers['if'].call(depth0, depth0 && depth0['export'], {
        hash: {},
    ...
    function program15(depth0, data) {
      var buffer = '',
        stack1;
      buffer += '\n        ';
      stack1 = helpers['if'].call(depth0, depth0 && depth0.add, {
        hash: {},
    ...
    stack1 = helpers['if'].call(depth0, depth0 && depth0.editor, {
      hash: {},
